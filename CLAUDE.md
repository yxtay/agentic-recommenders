...
Keep this file focused on workflow, commands, and conventions needed by AI coding agents during development.

## Session start

At the start of every conversation, read `README.md` and `AGENTS.md` in full before doing anything else.
...
# run a single test
uv run pytest tests/test_index.py::TestSearch::test_hybrid_search_returns_table -v
```
